...
export default {
  ...
  methods: {
    ...
    getList() {
      accountTransactionApi.GetProblemOrderAysnc(this.params).then(res => {
    ...
    submit(value) {
      this.$refs.form.validate((valid) => {
        if (valid) {
          accountTransactionApi.HandelCustomerServiceOrderAysnc(this.form).then(res => {
            if (res.data.success) {
              this.$message({
                message: '操作成功',
                type: 'success'
